-- ------------------
-- 用户系统数据库表结构
-- $Id: users.sql 253 2014-10-23 02:54:39Z yichuan $
...
CREATE TABLE `USER_PROFILE` (
  ...
  `MARRIAGE` varchar(2) DEFAULT NULL COMMENT '婚姻状况（见MIXED_DICT）',
  `EDUCATION` varchar(2) DEFAULT NULL COMMENT '教育情况（见MIXED_DICT）',
  `POSITION` varchar(4) DEFAULT NULL COMMENT '职位（见MIXED_DICT）',
...
CREATE TABLE `USER_EDUCATION` (
  ...
  `EDUCATION` VARCHAR(2) NOT NULL COMMENT '学历（见MIXED_DICT）',
...
CREATE TABLE `USER_AUTHC` (
  ...
  `EDUCATION` varchar(2) DEFAULT NULL COMMENT '教育信息[学历]（见MIXED_DICT[education]）',
...
CREATE TABLE `EMAIL_VERIFY_SOURCE` (
  ...
  `DEADLINE` bigint(20) DEFAULT NULL COMMENT '有效(截止)时间',
...
CREATE TABLE `SCORE_RANK` (
  ...
  `SCORE_CAPITAL_INFO` varchar(500) DEFAULT NULL COMMENT '积分等级相关资本信息',

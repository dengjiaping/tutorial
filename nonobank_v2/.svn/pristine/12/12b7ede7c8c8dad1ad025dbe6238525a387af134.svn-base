...
public class QScoreRank extends QAbstractRecording<ScoreRank> {
    ...
    public final StringPath scoreCapitalInfo = createString(PROP_SCORE_CAPITAL_INFO);
    ...
    public void addMetadatas() {
        ...
        addMetadata(scoreCapitalInfo, named("SCORE_CAPITAL_INFO").ofType(VARCHAR).withSize(500));

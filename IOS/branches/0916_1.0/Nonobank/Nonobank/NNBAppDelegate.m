...
{
    [MobClick startWithAppkey:@"54195380fd98c5afeb008842" reportPolicy:BATCH   channelId:nil];
...
//    UINavigationController *navigationController = [[UINavigationController alloc] initWithRootViewController:[[ NNBLeftViewController alloc] init]];

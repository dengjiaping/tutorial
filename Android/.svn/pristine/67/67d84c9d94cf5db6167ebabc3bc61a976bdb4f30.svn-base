...
public class ChangePayPwdActivity extends BaseActivity {
	...
	private void initView() {
		etOldPwd = (EditText) findViewById(R.id.et_old_pay_pwd);
		etPwd = (EditText) findViewById(R.id.et_pay_pwd);
		etEnsurePwd = (EditText) findViewById(R.id.et_ensure_pay_pwd);
		btChangePwd = (Button) findViewById(R.id.bt_change_pay_pwd);
	...
	public void onClick(View v) {
		if (v == btChangePwd) {
			...
			userEngine.changePayPassword(sessionId, MD5Util.getMD5String(oldPwd),
